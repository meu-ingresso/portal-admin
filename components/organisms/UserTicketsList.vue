  ...
  <div>
    ...
    <div v-else>
      ...
      <EmptyState
        ...
        subtitle="Quando você comprar ingressos, eles aparecerão aqui."
      ...
      <div v-else>
        <v-card 
          ...
          :key="ticket.id" 
          class="mb-4 ticket-card"
          outlined
        >
          <div class="d-flex flex-column flex-md-row">
            <div class="ticket-image-container">
              <v-img
                :src="ticket.event.cover_image || require('@/assets/images/default_banner.png')"
                height="150"
                cover
              >
    ...
    >
      <v-card v-if="selectedTicket">
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn
            v-if="selectedTicket.status === 'Confirmado'"
            color="success"
            text
  ...
  methods: {
    ...
    async fetchTickets() {
      try {
        ...
        const response = await user.getUserTickets({
        ...
        this.totalPages = response.meta?.lastPage || 1;
        */
