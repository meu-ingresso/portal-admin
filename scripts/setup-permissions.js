...
const PRODUCER_ROLES = [
  {
    name: PRODUCER_ROLE,
    permissions: [
      PRODUCER_PERMISSIONS.VIEW,
      PRODUCER_PERMISSIONS.EDIT,
      EVENT_PERMISSIONS.VIEW,
      EVENT_PERMISSIONS.VIEW_TICKETS,
      EVENT_PERMISSIONS.VIEW_COUPONS,
      EVENT_PERMISSIONS.VIEW_COLLABORATORS,
...
const ALL_ROLE_DEFINITIONS = [...EVENT_COLLABORATOR_ROLES, ...ADMIN_ROLES, ...PRODUCER_ROLES];
